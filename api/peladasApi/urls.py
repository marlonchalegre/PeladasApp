...
urlpatterns = [
    ...
    path('api/organizacao/list', OrganizacaoListUser.as_view()),
    path('api/organizacao/<int:pk>', OrganizacaoDetailViewSet.as_view(), name='organizacao-detail'),
    ...
    path('api/pelada/<int:pk>/jogadores/<int:user_id>', JogadorPeladaViewSet.as_view(), name='jogador-pelada'),
    ...
    path('api/user/list/', views_user.ListUserViewSet.as_view(), name='user-detail'),
